...
@Component({
  ...
  imports: [RouterLink, DecimalPipe, DatePipe, Spinner, Pagination, EmptyState, Callout, StatusBadge],
...
export class OrdersListPage {
  ...
  protected readonly heading = computed<string>(() => (this.auth.isAdmin() ? 'Orders' : 'My Orders'));
